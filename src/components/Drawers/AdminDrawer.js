  ...
  return (
    <div className={classes.root}>
      ...
      >
        ...
        <Divider />
        <List>
          <ListItem className={classes.listItem} button key="StartManager" disabled={managerStatus}>
            <ListItemIcon onClick={startManager}>
              <PlayArrowIcon />
            </ListItemIcon>
            <ListItemText primary="Start Manager" />
          </ListItem>
          <ListItem className={classes.listItem} button key="StopManager" disabled={!managerStatus}>
            <ListItemIcon onClick={stopManager}>
              <StopIcon />
            </ListItemIcon>
            <ListItemText primary="Stop Manager" />
          </ListItem>
          <ListItem className={classes.listItem} button key="RestartContract" disabled={managerStatus}>
            <ListItemIcon onClick={restartContract}>
              <ReplayIcon />
            </ListItemIcon>
            <ListItemText primary="Restart Contract" />
          </ListItem>
          <ListItem className={classes.listItem} button key="ReallocateTasks" disabled={managerStatus}>
